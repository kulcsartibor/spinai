---
title: Token Cost Calculations Update
description: Documentation on the updated token cost calculations including new models and changes to existing utilities.
---

## Updated Token Cost Calculations

The token cost calculations for AI model usage have been updated to include new models, particularly from Cloudflare AI, and adjustments to existing models. This update ensures more accurate billing and resource allocation for users leveraging these models through our platform.
