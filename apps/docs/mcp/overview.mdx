...
If you're following the step-by-step guide, create a new SpinAI project using the default template. Otherwise, **you can skip all these steps and choose the github-mcp-example for the full code**.
